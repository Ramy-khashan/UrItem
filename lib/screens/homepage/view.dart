...
import 'package:uritem/screens/fillter/view.dart';
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          return InkWell(
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => AddingDataScreen(
                                              isUpdate: true,
                                              title: controller.data[i]
                                                  ['title'],
                                              data: controller.data[i]['data'],
                                              price: controller.data[i]
                                                  ['price'],
                              ...
                              child: ItemShape(
                                onDelete: () {
                                  controller.deleteItem(context, i, size);
                                },
